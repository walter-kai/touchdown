...
// GameCard component moved outside to prevent re-creation on parent re-renders
const GameCard: React.FC<{ game: Event }> = React.memo(({ game }) => {
...
// NewsCard component moved outside to prevent re-creation on parent re-renders
