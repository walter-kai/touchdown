      ...
      <div className="bg-bg-dark border-2 border-neon-cyan/50 rounded-xl p-8 max-w-md w-full mx-4 shadow-2xl shadow-neon-cyan/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <button
              type="submit"
              disabled={loading || !displayName.trim() || (hasChanged && isAvailable !== true) || checkingAvailability}
              className={`flex-1 py-3 px-6 rounded-lg font-semibold transition-all flex items-center justify-center gap-2 ${
                loading || !displayName.trim() || (hasChanged && isAvailable !== true) || checkingAvailability
